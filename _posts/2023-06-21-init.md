...
I’m grabbing a sample from the top of list over at MalwareBazaar.

https://bazaar.abuse.ch/sample/e0679959a4449e2af449f936597402e8197af11a25b670126eff3e92c1d2b6f0/

Last public analysis of ****N-W0rm**** comes from SECUINFRA Falcon team [[1](https://www.notion.so/N-W0rm-2023-03-28-7de4db9e1d904c7db047fced785beed1?pvs=21)][[2](https://www.notion.so/N-W0rm-2023-03-28-7de4db9e1d904c7db047fced785beed1?pvs=21)] January 2, 2021 and April 2, 2021.
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/c717788e-6d03-4a23-a892-6fcc17cf3861/Untitled.png)
...
After downloading the sample to a remnux and windows vm, I ran `peframe`[[3](https://www.notion.so/N-W0rm-2023-03-28-7de4db9e1d904c7db047fced785beed1?pvs=21)] on the executable to get a good overview of what I need to start focusing my efforts on.
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/5c58b43e-fce6-4eec-ad74-7c1cbcff2c2a/Untitled.png)
...
- Output from `peframe`
    ...
    XLMMacroDeobfuscator: pywin32 is not installed (only is required if you want to use MS Excel)
    /usr/local/lib/python3.8/dist-packages/peframe/modules/yara_check.py:14: RuntimeWarning: too many matches for string $a in rule "Microsoft_Visual_Cpp_8"
      for match in rules.match(filename):
    /usr/local/lib/python3.8/dist-packages/peframe/modules/yara_check.py:14: RuntimeWarning: too many matches for string $a in rule "Microsoft_Visual_Cpp_8_additional"
      for match in rules.match(filename):
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/cec1201c-6fc5-42c7-89d1-973c051512f9/Untitled.png)
...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/1286cc31-8826-4a3c-bd43-a6f7911229ca/Untitled.png)

![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/8efd9535-fd16-4700-a5a5-b2916741184a/Untitled.png)
